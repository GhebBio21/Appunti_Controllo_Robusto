...
L'esempio mostra che i pesi cambiano davvero il comportamento del sistema: un peso pi\`u severo a bassa frequenza migliora il rigetto dei disturbi, ma pu\`o rendere il tracking pi\`u aggressivo. La lezione si chiude poi aprendo il tema degli zeri RHP multivariabili, che ricordano una cosa essenziale: non tutte le prestazioni desiderate sono realizzabili, anche con la migliore scelta dei pesi.
...
Questa parte del documento \`e una traduzione e rielaborazione estesa delle slide 72--78 del PDF ``Formulation of Control Problems'', caricato dall'utente come materiale di partenza nella directory \texttt{Slide}.
...
La Lezione 15 si era fermata nel punto giusto: gli zeri RHP multivariabili non sono semplici zeri di singoli elementi della matrice $G(s)$, ma direzioni in cui la matrice di trasferimento perde rango. La Lezione 16 completa quell'esempio e poi cambia scala: non studia pi\`u solo un particolare schema di mixed sensitivity, ma introduce il linguaggio generale con cui si formulano i problemi di sintesi $\mathcal{H}_2$ e $\mathcal{H}_\infty$.

La lezione ha quindi due blocchi principali:
\begin{enumerate}
    \item chiusura dell'esempio sugli zeri RHP MIMO, mostrando come il loro effetto possa essere spostato fra le uscite e perch\'e la norma $\mathcal{H}_\infty$ vede soprattutto la direzione peggiore;
    \item introduzione della formulazione generale $P$-$K$, delle LFT e della costruzione della pianta generalizzata $P$ a partire da schemi a blocchi.
\end{enumerate}
...
Riprendiamo l'esempio introdotto alla fine della Lezione 15. La pianta \`e
$$
G(s)=
\frac{1}{(0.2s+1)(s+1)}
\begin{bmatrix}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{images16/formulation-79-84-001.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{images16/formulation-79-84-002.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{images16/formulation-79-84-003.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{images16/formulation-79-84-004.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{images16/formulation-79-84-005.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{images16/formulation-79-84-006.png}
...
\subsection{Dal problema specifico alla formulazione generale}

La seconda parte della lezione apre il capitolo sulla formulazione generale del problema di controllo. Finora abbiamo scritto a mano diversi stack:
$$
\begin{bmatrix}
W_P S\\
W_uKS
...
La Lezione 16 chiude il discorso sugli zeri RHP multivariabili e apre il linguaggio standard della sintesi robusta. Dal primo blocco bisogna ricordare che gli zeri MIMO sono direzionali: possono non comparire nei singoli canali, possono imporre una risposta inversa solo lungo certe combinazioni di ingresso e uscita, e in alcuni casi possono essere \emph{pinned} a un canale specifico.

Dal secondo blocco bisogna ricordare la struttura $P$-$K$. Tutti i problemi trattati nelle lezioni precedenti possono essere riscritti come:
$$
\begin{bmatrix}
z\\
v
...
Questa parte del documento \`e una traduzione e rielaborazione estesa delle slide 79--84 del PDF ``Formulation of Control Problems'' e delle pagine 1--24 del PDF ``General Control Problem Formulation -- $\mathcal{H}_2/\mathcal{H}_\infty$ control synthesis'', caricati dall'utente come materiale di partenza nella directory \texttt{Slide}.
